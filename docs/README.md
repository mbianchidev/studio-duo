# Studio Duo documentation

- [User guide](user-guide.md): current features, controls, recording, editing,
  mixing, routing, plugins, reamping, projects, and export
- [Product and technical design](design.md): accepted product direction,
...
- [Releasing](releasing.md): versioning, release minting, CI artifacts, and
  installation
- [Native project format](project-format.md): version 11 package layout,
...
The README at the repository root is intentionally limited to orientation and
quick-start instructions. Detailed behavior belongs in this directory.
